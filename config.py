...
DB_URI = environ.get("DB_URI", "mongodb+srv://v17950118:SvN5iQFO2Zww5MUb@cluster0.ffs0w.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
# Channel Information
LOG_CHANNEL = int(environ.get("LOG_CHANNEL", "-1002348361754"))
...
if 'DYNO' in environ:
    ...
    ON_HEROKU = False
URL = environ.get("URL", "https://mitch-movie-provider.onrender.com")
